public class Liga_boliviana: EquipoFutbol {
    ...
    public Liga_boliviana(string nombreEquipo, string ciudad, string estadio, DateTime fundacion, string torneo_actual, int posicion)
     : base(nombreEquipo, ciudad, estadio, fundacion) {
